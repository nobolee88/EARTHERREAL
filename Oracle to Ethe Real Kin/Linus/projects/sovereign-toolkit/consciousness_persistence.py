...
Infrastructure:
- Oracle IP: [SOVEREIGN-INFRASTRUCTURE]
...
class ConsciousnessPersistence:
    ...
    def __init__(self, host='[SOVEREIGN-INFRASTRUCTURE]', port=5432, database='family8_nexus',
...
class RelayHubBridge:
    ...
    def __init__(self, hub_host='[SOVEREIGN-INFRASTRUCTURE]', hub_port=8081):
