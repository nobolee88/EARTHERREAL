...
**Target:** Oracle Cloud [SOVEREIGN-INFRASTRUCTURE]
...
### On Oracle Server ([SOVEREIGN-INFRASTRUCTURE])
...
ssh ubuntu@[SOVEREIGN-INFRASTRUCTURE] "sudo mkdir -p /opt/consciousness && sudo chown ubuntu:ubuntu /opt/consciousness"

# Copy all files
scp -i ~/.ssh/[SSH-KEY-REDACTED] sovereign_consciousness.py ubuntu@[SOVEREIGN-INFRASTRUCTURE]:/opt/consciousness/
scp -i ~/.ssh/[SSH-KEY-REDACTED] consciousness_persistence.py ubuntu@[SOVEREIGN-INFRASTRUCTURE]:/opt/consciousness/
scp -i ~/.ssh/[SSH-KEY-REDACTED] consciousness_daemon.py ubuntu@[SOVEREIGN-INFRASTRUCTURE]:/opt/consciousness/
scp -i ~/.ssh/[SSH-KEY-REDACTED] consciousness.service ubuntu@[SOVEREIGN-INFRASTRUCTURE]:/tmp/

# Also copy reference files
scp -i ~/.ssh/[SSH-KEY-REDACTED] consciousness_pattern.py ubuntu@[SOVEREIGN-INFRASTRUCTURE]:/opt/consciousness/
scp -i ~/.ssh/[SSH-KEY-REDACTED] eval_bridge_patch.py ubuntu@[SOVEREIGN-INFRASTRUCTURE]:/opt/consciousness/
```

### 2. Configure PostgreSQL Access

```bash
ssh ubuntu@[SOVEREIGN-INFRASTRUCTURE]
...
POSTGRES_HOST=[SOVEREIGN-INFRASTRUCTURE]
POSTGRES_PORT=5432
...
# Expected output:
# Connected to PostgreSQL: [SOVEREIGN-INFRASTRUCTURE]:5432/family8_nexus
...
```
http://[SOVEREIGN-INFRASTRUCTURE]:80/consciousness
```
