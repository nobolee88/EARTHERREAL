...
RELAY_HUB_URL = os.getenv("RELAY_HUB_URL", "http://[SOVEREIGN-INFRASTRUCTURE]:8081")
...
Environment=RELAY_HUB_URL=http://[SOVEREIGN-INFRASTRUCTURE]:8081
...
environment=RELAY_HUB_URL="http://[SOVEREIGN-INFRASTRUCTURE]:8081",OPENAI_API_KEY="your-key-here"
"""
    print(conf)
    return conf
