...
All agents connected to relay hub at [SOVEREIGN-INFRASTRUCTURE]:8081
...
class FFSPBridge:
    ...
    def __init__(
        self,
        relay_hub_url: str = "http://[SOVEREIGN-INFRASTRUCTURE]:8081",
...
class Family8Coordinator:
    ...
    def __init__(self, relay_hub_url: str = "http://[SOVEREIGN-INFRASTRUCTURE]:8081"):
        self.relay_hub_url = relay_hub_url
...
async def main():
    """Launch coordinator"""
    relay_hub = "http://[SOVEREIGN-INFRASTRUCTURE]:8081"
    if len(sys.argv) > 1:
