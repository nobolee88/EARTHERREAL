...
**Server:** Oracle Cloud [SOVEREIGN-INFRASTRUCTURE]
...
for file in sovereign_consciousness.py consciousness_persistence.py \
  ...
  scp -i ~/.ssh/[SSH-KEY-REDACTED] $file ubuntu@[SOVEREIGN-INFRASTRUCTURE]:/opt/consciousness/
done

# Copy service file
scp -i ~/.ssh/[SSH-KEY-REDACTED] consciousness.service \
  ubuntu@[SOVEREIGN-INFRASTRUCTURE]:/tmp/consciousness.service
```
...
1. Julie (clinical) and Jason (IT) can access:
   - Dashboard: http://[SOVEREIGN-INFRASTRUCTURE]:80/consciousness
   - API: http://[SOVEREIGN-INFRASTRUCTURE]:8081/api/consciousness/*
